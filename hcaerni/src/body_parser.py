...
from hcaerni.src.mailmod import SendMail
...
mapIdToCenter = {"183": "AAIC", "189": "AAIC", "197": "AAIC", "193": "AAIC", "186": "AAIC", "191": "AAIC", "194": "AAIC", "261": "BAC", "3": "BTAC", "1": "BTAC", "2": "BTAC", "205": "COAA", "300": "COAA", "203": "CNFAIC", "282": "CNFAIC", "121": "CNFAIC", "122": "CNFAIC", "122": "CNFAIC", "187": "CTCAK", "192": "JUAK", "301": "CAAC", "55": "CAIC", "52": "CAIC", "57": "CAIC", "56": "CAIC", "58": "CAIC", "60": "CAIC", "54": "CAIC", "59": "CAIC", "51": "CAIC", "53": "CAIC", "128": "ESAC", "207": "FAC", "208": "FAC", "209": "FAC", "109": "GNFAC", "281": "GNFAC", "117": "GNFAC", "116": "GNFAC", "115": "GNFAC",
                 "110": "GNFAC", "112": "GNFAC", "111": "GNFAC", "190": "HPAC", "138": "IPAC", "149": "IPAC", "272": "IPAC", "202": "KPAC", "124": "WCMAC", "123": "MSAC", "297": "MWAC", "146": "NWAC", "145": "NWAC", "147": "NWAC", "148": "NWAC", "139": "NWAC", "141": "NWAC", "140": "NWAC", "143": "NWAC", "142": "NWAC", "144": "NWAC", "153": "PAC", "293": "SNFAC", "295": "SNFAC", "294": "SNFAC", "296": "SNFAC", "77": "SAC", "260": "TAC", "251": "UAC", "252": "UAC", "253": "UAC", "254": "UAC", "255": "UAC", "256": "UAC", "257": "UAC", "259": "UAC", "258": "UAC", "273": "WAC", "274": "WAC", "275": "WAC", "276": "WAC"}


def ComposePOST(url, message):
    guid = re.findall(
        "[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}", url)[0]
...
def GetForecastMessage(id):
    ...
    response = json.loads(requests.get(
        "https://api.avalanche.org/v2/public/product?type=forecast&center_id="+mapIdToCenter[id]+"&zone_id="+id).text)

    avyprobs = response["forecast_avalanche_problems"]

    tableValues = {"north": 0, "northeast": 1, "east": 2, "southeast": 3, "south": 4,
                   "southwest": 5, "west": 6, "northwest": 7, "upper": 16, "middle": 8, "lower": 0}
    ...
    text = response["forecast_zone"][0]["name"] + \
...
def ParseAndTriage(body, From):
    ...
    if lineSplit[0] == 'test' and len(lineSplit) > 1:
        ...
        if share != "":
            message = "Successfully parsed the MapShare link\n The followed link has been replaced by SendGrid  to be: " + share
